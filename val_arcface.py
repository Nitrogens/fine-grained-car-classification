...
if __name__ == "__main__":
  ...
  parser.add_argument('--load_path', type=str, default="/home/xmj/ml-course/car/experiments/arcface-model-model_arcface-64-50-0.1-0.1-20-FocalLoss-64.0-0.5-False-0.5-2.0")
